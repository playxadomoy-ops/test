...
async def main(page: ft.Page) -> None:
    ...
    try:
        ...
        def _on_server_status_changed(status_code: str, message: str) -> None:
            ...
            server = server_client.discovered_server
            settings_view.set_server_details(
                f"{server.ip}:{server.api_port}" if server else None,
        ...
        async def _start_server_connection() -> None:
            ...
            discovers the server over the LAN, registers this device if it
        ...
        async def _initialize() -> None:
            ...
            try:
                ...
                overview_view.set_server_status("discovering", "Пошук сервера...")
                settings_view.set_server_status("discovering", "Пошук сервера...")
