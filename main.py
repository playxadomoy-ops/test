...
async def main(page: ft.Page) -> None:
    ...
    try:
        ...
        async def _start_compass_sensor_deferred() -> None:
            ...
            reports both required sensors present, start_listening()
            (creates and registers the real-time listener). A short
            delay before even the first stage keeps this fully out of
            the way of the app's first paint and the rest of this
            function's own startup work below.
            ...
            try:
                ...
                if diagnostics.compass_functional:
