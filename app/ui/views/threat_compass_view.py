...
_LEGEND_ENTRIES: tuple[tuple[str, str], ...] = (
    ("Shahed / БПЛА", "icons/shahed_uav.png"),
    ("Крилата ракета", "icons/cruise_missile.png"),
    ("Балістична ракета", "icons/ballistic_missile.png"),
    ("Авіація", "icons/aircraft.png"),
)

_CATEGORY_ICON: dict[ThreatType, str] = {
    ThreatType.SHAHED: "icons/shahed_uav.png",
    ThreatType.MISSILE: "icons/cruise_missile.png",
    ThreatType.AIRCRAFT: "icons/aircraft.png",
}
