...
_LEGEND_ENTRIES: tuple[tuple[str, str], ...] = (
    ("Shahed / БПЛА", theme.THREAT_ICON_UAV),
    ("Крилата ракета", theme.THREAT_ICON_CRUISE),
    ("Балістична ракета", theme.THREAT_ICON_BALLISTIC),
    ("Авіація", theme.THREAT_ICON_AIRCRAFT),
)
