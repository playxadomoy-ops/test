...
#: just a 4-point diamond. Pushed close to the canvas edge on every side.
_SHAHED_UAV_RING = [
    (97, 50),   # nose
    (56, 34),   # upper body shoulder
    (4, 5),     # upper wingtip (swept far back)
    (34, 50),   # tail notch (concave -- the characteristic "M" wing)
    (4, 95),    # lower wingtip
    (56, 66),   # lower body shoulder
]

#: Cruise missile -- slim cylindrical body, pointed nose, cross-tail fins.
#: Fins spread much further vertically than before (was only ~52% of the
#: canvas height -- looked small/"padded" next to the other icons at the
#: same on-screen size); body slightly thicker too.
_CRUISE_MISSILE_BODY = [
    (96, 50), (74, 41), (22, 41), (22, 59), (74, 59),
]
_CRUISE_MISSILE_FIN_UPPER = [(22, 41), (3, 10), (27, 39)]
_CRUISE_MISSILE_FIN_LOWER = [(22, 59), (3, 90), (27, 61)]
...
_BALLISTIC_MISSILE_BODY = [
    (95, 50), (66, 24), (24, 29), (24, 71), (66, 76),
]
_BALLISTIC_MISSILE_FIN_UPPER = [(24, 29), (2, 5), (28, 27)]
_BALLISTIC_MISSILE_FIN_LOWER = [(24, 71), (2, 95), (28, 73)]

#: Generic/carrier aircraft -- fuselage + large swept wings + small
#: tailplane, recognizable as a fixed-wing jet from directly above.
_AIRCRAFT_FUSELAGE = [
    (95, 50), (73, 45), (16, 46), (5, 50), (16, 54), (73, 55),
]
_AIRCRAFT_WING_UPPER = [(62, 49), (10, 4), (36, 46)]
_AIRCRAFT_WING_LOWER = [(62, 51), (10, 96), (36, 54)]
_AIRCRAFT_TAIL_UPPER = [(19, 49), (5, 30), (16, 47)]
_AIRCRAFT_TAIL_LOWER = [(19, 51), (5, 70), (16, 53)]
